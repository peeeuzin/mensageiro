...
#[tokio::test]
pub async fn connect_mensageiro() {
...
#[tokio::test]
pub async fn send_generic_message_mensageiro() {
    let addr = "0.0.0.0:6572";
...
#[tokio::test]
pub async fn send_publish_message_mensageiro() {
    let addr = "0.0.0.0:6572";
...
#[tokio::test]
pub async fn send_subscribe_message_mensageiro() {
    let addr = "0.0.0.0:6572";
